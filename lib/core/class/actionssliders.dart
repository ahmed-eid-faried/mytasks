...
class MyHomePageSliders extends StatefulWidget {
  const MyHomePageSliders({Key? key}) : super(key: key);

  @override
  State<MyHomePageSliders> createState() => _MyHomePageSlidersState();
}

class _MyHomePageSlidersState extends State<MyHomePageSliders> {
